...
<body>
    ...
    <script>
        ...
        const textLetterH2 = "Gửi Tô Cẩm and Phương Thủy";
        ...
        const textLetterP = "Hôm nay là ngày 20/10 chúc 2 đứa luôn hạnh phúc và gặp nhiều may mắn trong cuộc sống nhá. Hãy luôn giữ mãi nụ cười trên môi nhá và đừng suy nghĩ nhiều về những thứ không đáng nha";
